local bufferline = require 'colorsheme.nier-light.integrations.bufferline'
local cmp = require 'colorsheme.nier-light.integrations.cmp'
local colorscheme = require 'colorsheme.nier-light.colorscheme'
local config = require 'colorsheme.nier-light.config'
local utils = require 'colorsheme.nier-light.utils'
local theme = {}
